...
{
    public partial class IssueTransferForm : Form
    {
        public IssueTransferForm()
        {
            InitializeComponent();
        }

        private void IssueTransferForm_Load(object sender, EventArgs e)
        {
        ...
        private void LoadApprovedTransfers()
        {
            string query = @"
        ...
        private void btnIssue_Click(object sender, EventArgs e)
        {
            ...
            string update = @"UPDATE RawMaterialTransfer
                SET Status = 'Issued', IssuedBy = @staff, IssuedDate = CURDATE()
            ...
            try
            {
                ...
                if (rowsAffected > 0)
                {
                    MessageBox.Show($"Transfer {transferId} issued.", "Issued",
